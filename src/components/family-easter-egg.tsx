...
export function FamilyEasterEgg() {
  ...
  return (
    <button
      ...
      className="group relative size-50"
    >
      <Image
        src={ProfilePicture}
        width={200}
      ...
      <div className="pointer-events-none absolute -top-12 -left-10 origin-bottom-right -rotate-6 scale-0 rounded-md bg-white p-2 pb-6 opacity-0 shadow-2xl ring-1 ring-black/5 transition-all delay-75 duration-300 ease-out group-hover:scale-100 group-hover:opacity-100 group-data-open:scale-100 group-data-open:opacity-100 motion-reduce:transition-none sm:-left-16 dark:bg-zinc-100 dark:shadow-none">
        <Image
          ...
          className="size-28 rounded-sm object-cover outline-1 -outline-offset-1 outline-black/10"
          placeholder="blur"
        />
      </div>
      <div className="pointer-events-none absolute top-2 -right-10 origin-bottom-left rotate-6 scale-0 rounded-md bg-white p-2 pb-6 opacity-0 shadow-2xl ring-1 ring-black/5 transition-all duration-300 ease-out group-hover:scale-100 group-hover:opacity-100 group-data-open:scale-100 group-data-open:opacity-100 motion-reduce:transition-none sm:-right-16 dark:bg-zinc-100 dark:shadow-none">
        <Image
          src={FamilyPicture}
          width={112}
          height={112}
